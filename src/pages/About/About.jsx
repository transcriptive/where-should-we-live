    ...
    <div className="min-h-screen bg-white flex max-w-7xl  mx-auto">
        ...
        <div className="text-left pl-24 pr-20 pt-16">
            ...
            <div className="pt-5">
                ...
                <div className="text-24 font-roboto pt-3">
                    <p> Move the sliders to your desire preferences. They are designed to give you control over what is important to you.</p> 
                    <p className="mt-6">Connect.US will give you counties that are similar in nature based off your preferences.</p>
                </div>
            </div>
        </div>
    </div>
